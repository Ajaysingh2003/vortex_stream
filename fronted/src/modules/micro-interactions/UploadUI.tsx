            ...
            <div className="w-full h-full relative p-4">
              <div className=" absolute w-115 z-10  -bottom-24 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-md overflow-hidden">
                <div className="w-full overlap-card  rounded-lg max-w-sm lg:max-w-128  shadow-[0_-2px_4px_0_rgba(0, 0, 0, 0.82)]  shadow-black/15 rounded-[10px]  bg-[#f5f5f5]">
                  <div className="bg-[#f7f7f7]z border-b border-[#eee] py-2 px-4 w-full flex justify-between items-center">
              ...
              <div className="flex justify-between">
                ...
                <div className="flex items-center gap-3">
                  <div
                    role="button"
                    className="bg-muted secondary-btn text-black border-black/30 border-[0.5px] bg-background-btnx text-center rounded-md px-2 h-9 gap-2 flex items-center justify-center font-medium animate"
                  >
                  ...
                  <div
                    role="button"
                    className="bg-mutedz primary-btn text-black border-black/30 border-[0.5px] bg-background-btn text-center rounded-md px-6 !h-7 gap-2 flex items-center justify-center font-medium animate"
                  >
                      ...
                      <table className="w-full border-collapse text-left">
                        ...
                        <tbody className="divide-y divide-slate-100 text-sm text-slate-700">
                          ...
                          <tr className=" group text-accent transition-colors">
                            ...
                            <td className="py-3.5 px-5 flex items-center gap-3">
                              <div className=" size-9 p-1 rounded-lg  flex items-center justify-start">
                               
                                {/* <Clapperboard className="size-10 text-black"/> */}
                                <Image className="size-6" src={"/video-player.png"} height={100} width={100} alt="player" />
                              </div>
                              <span className="font-medium text-accent">
