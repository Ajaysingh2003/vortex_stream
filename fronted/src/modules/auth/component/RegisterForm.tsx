    ...
    <div className="w-82">
      <div className="w-full">
        <form onSubmit={handleSubmit} className="w-full">
          ...
          {!showPasswordField && (
            <Button
              ...
              className="w-full cursor-pointer tracking-wide mt-5 rounded-md bg-background-btn"
            >
              Continue
            </Button>
          )}
        ...
        <div className="flex items-center justify-center mt-3">
          <h3 className="text-[14px] text-stone-500 font-medium">
            Don't have an account?{" "}
            <Link
              className="font-semibold hover:underline duration-300 ease-in-out transition-all leading-relaxed text-accent"
              href="/login"
            >
              Sign In
            </Link>
