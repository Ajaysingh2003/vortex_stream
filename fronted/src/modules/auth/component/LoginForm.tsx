    ...
    <div className="w-82">
      <div className="w-full">
        ...
        <div className="flex items-center justify-center mt-3">
              <h3 className="text-[14px] text-stone-500 font-medium">Don't have an account? <Link className="font-semibold hover:underline duration-300 ease-in-out transition-all leading-relaxed text-accent" href="/register">Sign up</Link></h3>
        </div>
      </div>
    </div>
  );
