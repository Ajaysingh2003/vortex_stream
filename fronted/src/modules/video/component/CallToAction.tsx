...
function CallToAction() {
  ...
  return (
    <div className='text-[13px] space-y-4 w-full mt-3'>
      ...
      {/* Sub Title Field */}
      <div className='flex flex-col gap-1.5'>
        <Label htmlFor='sub-title' className='text-gray-600 font-medium'>Sub Title</Label>
        <Input 
          id='sub-title' 
          value={ctaSubTitle || ''} 
      ...
      <div className='flex flex-col gap-1.5'>
        <Label htmlFor='btn-text' className='text-gray-600 font-medium'>CTA Button Text</Label>
        <Input 
          id='btn-text' 
          value={ctaBtnText || ''} 
      ...
      <div className='flex flex-col gap-1.5'>
        <Label htmlFor='url' className='text-gray-600 font-medium'>CTA Redirect URL</Label>
        <Input 
          id="url" 
          type="url"
          value={ctaBtnUrl || ''} 
